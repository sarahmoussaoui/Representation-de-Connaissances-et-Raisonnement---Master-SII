...
class ReseauSemantiqueInformatique {
    ...
    // Méthode pour générer un graphe GraphStream à partir du réseau sémantique informatique
    Graph genererGraphe() {
    ...
    void visualiserReseauAvecMarqueurs(List<ConceptInformatique> conceptsMarques, List<ConceptInformatique> conceptsReponse, int questionId) {
        // Créer une instance de Graph
        Graph graph = genererGraphe();
...
public class Main6 {
    ...
    List<ConceptInformatique> conceptsMarques1 = reseauInformatique.repondreQuestionInformatique(question1,"est un");
    ...
    List<ConceptInformatique> conceptsMarques2 = reseauInformatique.repondreQuestionInformatique(question2,"conduit à");
    ...
    List<ConceptInformatique> conceptsMarques3 = reseauInformatique.repondreQuestionInformatique(question3,"utilisé dans");
    ...
    List<ConceptInformatique> conceptsMarques4 = reseauInformatique.repondreQuestionInformatique(question4,"utilise");
